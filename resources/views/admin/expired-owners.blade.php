...
{{--                                                @method('delete')--}}
                                                @csrf
                                                <td class="w-10 text-center">
                                                    <a href="#" data-id="{{ $owner->id }}" onclick="deletePost(this)" class="flex mx-auto text-black bg-indigo-500 !important border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded">完全に削除</a>
